...
nomeegotouch {
    outputFiles(maliit-plugins-$${MALIIT_INTERFACE_VERSION}.pc, meego-im-framework.schemas)
} else {
...
install_pkgconfig.files = MeegoImFramework.pc maliit-plugins-$${MALIIT_INTERFACE_VERSION}.pc
