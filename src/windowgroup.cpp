                                              ...
                                              uint32_t version)
{
    ...
    if (!strcmp(interface, "input_panel")) {
        ...
        m_output = static_cast<wl_output *>(wl_registry_bind(m_registry, name, &wl_output_interface, 1));
        wl_output_add_listener (m_output, &maliit_output_listener, this);
    }
}
...
void WindowGroupPrivate::handleOutputGeometry(int32_t x,
                                              int32_t y,
                                              int32_t physical_width,
                                              int32_t physical_height,
                                              int32_t subpixel,
...
void WindowGroupPrivate::handleOutputMode(uint32_t flags,
                                          int32_t width,
                                          int32_t height,
                                          int32_t refresh)
{
