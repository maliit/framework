...
maliit_input_method_class_init (MaliitInputMethodClass *input_method_class)
{
     ...
     * @x: X coordinate of new input method area.
     * @y: Y coordinate of new input method area.
...
static void
update_input_method_area(MeegoIMContextDbusObj *maliit_ic G_GNUC_UNUSED,
...
maliit_input_method_init (MaliitInputMethod *input_method)
{
    ...
    g_signal_connect(connection->dbusobj, "update-input-method-area",
 ...
 * @x: (out): X coordinate of current input method area.
 * @y: (out): Y coordinate of current input method area.
