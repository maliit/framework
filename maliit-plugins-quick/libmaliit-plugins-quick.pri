...
LIBS += $$TOP_DIR/maliit-plugins-quick/input-method/$$maliitDynamicLib($${MALIIT_PLUGINS_QUICK_LIB})
POST_TARGETDEPS += $$TOP_DIR/maliit-plugins-quick/input-method/$$maliitDynamicLib($${MALIIT_PLUGINS_QUICK_LIB})
